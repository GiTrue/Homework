...
import os # Добавлено для MEDIA_ROOT/URL
...
INSTALLED_APPS = [
    ...
    # --- Приложение проекта ---
    'logistic', # Убедитесь, что это правильное имя вашего приложения
]
...
REST_FRAMEWORK = {
    # Настройка пагинации по умолчанию (LimitOffsetPagination)
    'DEFAULT_PAGINATION_CLASS': 'rest_framework.pagination.LimitOffsetPagination',
    'PAGE_SIZE': 10,  # Количество элементов на странице по умолчанию
    
    # Настройка фильтрации по умолчанию
