...
Инструкции по запуску с данными из JSON

Для того чтобы книги появились на сайте, после создания и миграции модели (файла models.py) необходимо загрузить данные из файла books.json.
...
3. Загрузите данные из JSON-файла (при условии, что books.json находится в папке books/fixtures/):
...
После этого вы увидите книги по адресу /books/ и сможете переходить по датам, например, /books/2018-02-27/.